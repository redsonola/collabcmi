...
export class VerletStick extends THREE.Group {
  ...
  constrainLen(): void {
    ...
    (this.line.geometry as BufferGeometry).attributes.position.setXYZ(0, this.start.position.x, this.start.position.y, this.start.position.z);
    (this.line.geometry as BufferGeometry).attributes.position.setXYZ(1, this.end.position.x, this.end.position.y, this.end.position.z);
